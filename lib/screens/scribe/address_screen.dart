...
class _AddressScreenState extends State<AddressScreen> {
  ...
  void initState() {
    ...
    speak("Please Tell us Your Address");
  }
  ...
  void _listen() async {
    ...
    await _speech.listen(
      ...
      onResult: (val) => setState(
        () async {
          controller.addressController.value.text = val.recognizedWords;
          // await _speech.stop();
          // speak("Validation ${controller.AddressController.value.text}");
          // _speech.isNotListening ? _listen() : _stopListener();
        },
      ),
    );
                ...
                children: [
                  ...
                  RoundedButton(
                    ...
                    onPressed: () {
                      ...
                      controller.createCandidate(context);
                      // }
                    },
                  ),
                ],
