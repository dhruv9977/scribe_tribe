...
class _StateScreenState extends State<StateScreen> {
  ...
  void initState() {
    ...
    speak("Please Tell us Your State");
  }
  ...
  void _listen() async {
    ...
    await _speech.listen(
      ...
      onResult: (val) => setState(
        () async {
          controller.stateController.value.text = val.recognizedWords;
          // await _speech.stop();
          // speak("Validation ${controller.stateController.value.text}");
          // _speech.isNotListening ? _listen() : _stopListener();
        },
      ),
    );
              ...
              child: Column(
                ...
                children: [
                  ...
                  buildTextFormField(
                    ...
                    errorText: 'Please enter the state',
                  ...
                  RoundedButton(
                    ...
                    onPressed: () {
                      ...
                      Get.toNamed(
                        RouteHelper.getStudentPinCodeScreen(),
                      );
                      // }
                    },
                  ),
