...
class _TimeState extends State<Time> {
  ...
  speak() async {
    ...
    await flutterTts.speak(
      "Please Tell us your exam time like 10 am or 3 pm",
    );
  ...
  void _listen() async {
    ...
    await _speech.listen(
      onResult: (val) => setState(() {
        controller.examTimeController.value.text = val.recognizedWords;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  buildTextFormField(
                    controller: controller.examTimeController.value,
                  ...
                  RoundedButton(
                    ...
                    height: 51,
                    onPressed: () {
                      Get.toNamed(RouteHelper.getStudentDurationScreen());
                    },
                  ),
                ],
              ),
